...
//           onChange={handleInputChange}
//           className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md text-ellipsis"
//           style={{ textOverflow: "initial", whiteSpace: "normal" }}
//           required
//         >
...
//           </option>
//           <option value="Activities of households as employers">
...
//           </option>
//           <option value="Business administration and support services">
...
//           <option value="Humanitarian/Human rights">
...
//           <option value="Transport and storage (incl. postal)">
...
//           <option value="Social media">Social media</option>
//           <option value="Word of mouth">Word of mouth</option>
//           <option value="Worked with Pasu Health before">
//             Worked with Pasu Health before
//           </option>
//         </select>
//       </div>
