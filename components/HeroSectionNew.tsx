...
import Aaron from "@/public/aaron-video.png";
...
// }) => {
//   return (
//     <div className="group relative bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 h-full flex flex-col">
//       {/* Gradient border on hover */}
//       <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-sky-600 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl" />
...
//       <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 to-sky-50 rounded-3xl opacity-50" />
...
//       {/* Cards Section */}
//       <section className="py-16 bg-white/50 p-8 rounded-2xl shadow-lg">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
//               label="Training"
//               title="Mental Health Training Courses"
//               description="Created by our experts and available virtually, in-person or via self-guided learning."
//               buttonText="Explore courses"
//               buttonHref="/#our-training-courses"
//             />
...
//             <Card
//               label="Resources"
//               title="Evidence-based tools & support"
//               description="Access proven strategies and resources designed to build resilience and foster wellbeing in your workplace."
//               buttonText="Learn more"
